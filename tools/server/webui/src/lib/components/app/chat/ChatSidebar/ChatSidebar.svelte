...
<ScrollArea class="h-[100vh]">
	<Sidebar.Header class=" top-0 z-10 gap-5 bg-sidebar/80 px-4 py-5 pb-2 backdrop-blur-xl md:sticky">
		<a href="#/" onclick={handleMobileSidebarItemClick} class="group/logo">
			<h1 class="inline-flex items-center gap-2 px-2 text-lg font-bold tracking-tight text-foreground/90 transition-colors group-hover/logo:text-primary">
				<span class="flex h-7 w-7 items-center justify-center rounded-lg bg-primary/10 text-xs font-black text-primary">&#x1F999;</span>
				llama.cpp
			</h1>
		</a>
	...
	<Sidebar.Group class="mt-2 space-y-1.5 p-0 px-4">
